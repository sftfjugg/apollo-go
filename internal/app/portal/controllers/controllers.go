...
func InitControllersFn(
	...
	return func(r *gin.Engine) {

		{
			...
			r.POST("/app_namespace/:env", uic.AuthPerm(constans.AppOperatePerm), appNamespaceController.Create)
			r.DELETE("/app_namespace/:env", uic.AuthPerm(constans.AppOperatePerm), appNamespaceController.DeleteById)
			r.DELETE("/app_namespace_by_name/:env", uic.AuthPerm(constans.AppOperatePerm), appNamespaceController.DeleteByNameAndAppId)
			r.PUT("/app_namespace/:env", uic.AuthPerm(constans.AppOperatePerm), appNamespaceController.Update)
			r.POST("/app_namespace_by_related/:env", uic.AuthPerm(constans.AppOperatePerm), appNamespaceController.CreateByRelated)
		...
		}
		{
			...
			r.POST("/item/:env", uic.AuthPerm(constans.AppOperatePerm), itemController.Create)
			r.POST("/item_by_text/:env", uic.AuthPerm(constans.AppOperatePerm), itemController.CreateByText)
			r.DELETE("/item/:env", uic.AuthPerm(constans.AppOperatePerm), itemController.DeleteById)
			r.PUT("/item/:env", uic.AuthPerm(constans.AppOperatePerm), itemController.Update)
			r.GET("/item_comment/:env", uic.AuthLogin(), itemController.FindAllComment)
			r.DELETE("/items/:env", uic.AuthPerm(constans.AppOperatePerm), itemController.DeleteByNamespaceId)
		...
		{
			r.POST("/release/:env", uic.AuthPerm(constans.AppOperatePerm), releaseController.Create)
			r.POST("/release_gray_total/:env", uic.AuthPerm(constans.AppOperatePerm), releaseController.ReleaseGrayTotal)
		}
		{
